...
- **Seller Surplus** — the theoretical basis for $Q$, the quasi-rent at risk, in [seller-surplus.md](../arguments/seller-surplus.md). Quasi-rent is the correct measure of what a seller loses when a deal dies after the engineering is spent, because it prices redeployability rather than hours worked.
